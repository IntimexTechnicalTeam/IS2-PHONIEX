    ...
    <div ref="outer" class="comments_warrper" >
        <div class="comments_container 000" v-if="showItems.length>0">
            <div class="comments_item" :class="{comments_item_border:index !== showItems.length}" v-for="(item,index) in showItems" :key="index">
                    ...
                    <div class="rightside">
                        <Rate disabled v-model="item.Sorce" :colors="['#ffbb07', '#ffbb07', '#ffbb07']" disabled-void-icon-class="el-icon-star-off"></Rate>
                    </div>
                <div class="clear"></div>
            ...
            <inPage v-model="CurrentPage" :total="TotalRecord" :pageNum="pageNumber"  v-show="TotalRecord>4"></inPage>
        </div>
