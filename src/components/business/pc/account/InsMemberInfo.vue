<template>
  <div class="MemberPc" :class="{'ENG' : $Storage.get('locale') === 'E'}">
    <div class="MemberInfoMain">
        <!-- 用户账号 -->
          ...
          >
            ...
            <FormItem :label="$t('Register.UserGender')" prop="Gender" class="Genderbox">
...
.MemberPc .el-form .el-radio__input .el-radio__inner{
    border: 1px solid #b59e72;
    width: 16px;
    height: 16px;
}
.MemberPc .el-form .el-radio__input.is-checked+.el-radio__label{
  color: #b59e72;
}
...
.MemberPc .el-form .el-radio__input.is-checked .el-radio__inner::after{
