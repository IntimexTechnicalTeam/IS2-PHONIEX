...
.mobileWarper.in_panel_warpper .in_num_label{
  display: block;
  width: auto!important;
  // margin-right: 1rem;
}
.mobileWarper.in_panel_warpper .el-input-number{
  border:1px solid #b59e72!important;
  box-sizing: border-box;
}
.mobileWarper.in_panel_warpper .el-input__inner{
  border:none!important;
  box-sizing: border-box;
  width: 4rem;
}
.mobileWarper.in_panel_warpper .in_num_main .el-input-number__decrease, .mobileWarper.in_panel_warpper .in_num_main .el-input-number__increase{
...
.mobileWarper.in_panel_warpper .in_num_main .el-input-number__decrease{
  left: 0;
  top: 0;
}
.mobileWarper.in_panel_warpper .in_num_main .el-input-number__increase{
  right: 0;
  top: 0;
}
.mobileWarper.in_panel_warpper .in_num_main .el-input-number__decrease i, .mobileWarper.in_panel_warpper .in_num_main .el-input-number__increase i{
  color:#fff;
  font-size: 1.2rem;
    font-weight: bold;
    line-height: 2.6rem;
...
.mobileWarper.in_panel_warpper .el-input-number .el-input__inner{
  padding-left: 0rem;
  padding-right: 0rem;
