  ...
  <div class="insLogin_warrper" :class="{'ENG' : $Storage.get('locale') === 'E'}">
          ...
          <div class="register" v-show="tabIndex === 2">
              <div>
                ...
                <div class="register_half">
                    <InsInput2 class="UserFirstName" :placeholder="$t('Register.UserFirstName')"  v-model="registerForm.firstName" />
                    <InsInput2 class="UserLastName" :placeholder="$t('Register.UserLastName')"  v-model="registerForm.lastName"/>
                ...
                <!-- <div></div> -->
                <CheckboxGroup v-model="terms" style="margin: 20px 0 10px 0">
                    <Checkbox name="type"></Checkbox><span><router-link to="/CMS/content/20440" target="_blank" style="font-size: 14px;padding-left: 14px;color: #999999;
    text-decoration: none;">{{$t('Register.RegisterAgree')}}</router-link></span>
                ...
                <CheckboxGroup v-model="registerForm.OptOutReceiving" style="margin: 10px 0 20px 0">
                    <Checkbox name="type"></Checkbox><span><a href="javascript:;" style="font-size: 14px;padding-left: 14px;color: #999999;
