    ...
    <transition name="slide">
      <div key="1" v-if="!waiting" style="display:flex;">
        <div class="header-index">
          <swiper :options="swiperOptionhome" v-if="bannerList.length>0">
            <!-- slides -->
            <swiperSlide
            ...
            <!-- Optional controls -->
            <div class="swiper-pagination swiper-paginationhome" slot="pagination"></div>
            <!-- <div
...
export default class InsBanner extends Vue {
  ...
  swiperOptionhome: object = {
    ...
    pagination: {
      el: '.swiper-pagination.swiper-paginationhome',
      clickable: true
    }
  };
  getBanner () {
