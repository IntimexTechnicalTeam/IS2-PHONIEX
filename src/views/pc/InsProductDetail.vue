<template>
<div class="productDetailWarper PcVersion" :class="{'ENG' : $Storage.get('locale') === 'E'}">
  ...
  <div class="productDetail_container">
    <div class="productDetail_main">
      <inPreview style="width:520px" :imgList="ImgList" :pageNum="userAgent === 'mobile' ?  1 : 5" :ProductTitleName="ProductTitleName"></inPreview>
      <div style="width:650px;margin-left:30px;float:right;">
          <PkProductInfo :panelDetail.sync="PanelDetail"  :ProductSku="ProductCode" width="100%" :AddPrice="getNewsPrice" style="margin-top:30px;margin-bottom: 10px;"></PkProductInfo>
          <!-- <div class="ProductRate">
            <Rate  v-model="Score" disabled  disabled-void-color="#5f6548" disabled-void-icon-class="el-icon-star-off"></Rate>
            </div> -->
...
.ENG.PcVersion {
  ...
  .in_panel_header .in_panel_header_left{
    width: calc( 100% - 198px);
  }
  .in_panel_header .in_panel_header_right{
    width: 198px;
  }
  .in_panel_header .introduction p{
    font-size: 16px;
    line-height: 30px;
  }
  ...
  .in_panel_header .in_panel_header_right .in_pannel_addtofav, .productshare_icon_warpper{
    width: 86px;
    text-align: left;
    margin-left: auto;
    color: #666666;
  ...
  .in_panel_footer .in_btn{
    letter-spacing: 2px;
  }
  .productDetail_container .tab_warpper .tab_header .comment_title , .productDetail_container .tab_warpper .tab_header .detail_title{
    font-size: 18px;
    font-family: 'Domine-Bold' !important;
  }
}
...
.isActive{
  ...
  background: url(/images/pc/index_66.png) no-repeat center center !important;
  text-align: center;
}
