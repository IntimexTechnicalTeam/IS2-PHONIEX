<template>
  <div class="checkoutn_warpper mobileV">
    ...
    <div class="main_warpper">
        <div class="checkoutl checkoutr">
            <div class="shopCart_warpper">
              ...
              <div :style="{ height: items*120 + 'px'}" class="item_change">
    ...
    <div class="btn_warpper">
      <InsButton style="display:inline-block;" class="btnStyle" width="100%" size="middle" :nama="$t('CheckOut.Checkout')" @click="checkOut" :loading="COloading"/>
...
.shoppingcart_item_detail > .shoppingcart_item_qty{
  display: flex;
  justify-content: space-between;
}
