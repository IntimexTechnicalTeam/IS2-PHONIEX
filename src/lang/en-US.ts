export default {
  ...
  Account: {
    ...
    MemberInformation: 'User Information',
    MyMessages: 'My Mailbox',
  ...
  product: {
    ...
    Unit: 'Unit',
    Viewmore: 'See More',
    productclassification: 'Product Categories',
    share: 'Share',
    collect: 'Collect'
  },
  Shoppingcart: {
  ...
  MemberInfo: {
    MemberInfoTitle: 'User information',
